...
　　本篇文章累计了大量评论，和我的一些解答，读者有什么问题可以先看看评论，或者搜下关键字，如果还是有问题可以给我在评论里给我留言，问题很着急的可以加我 微信：13433622693　，或者给我发邮件：[969987665@qq.com](mailto:969987665@qq.com) 
...
翻到最下面，改成我这样子的，注意： `: 后面要有空格`
	...
	deploy:
	  type: git
	  repository: https://github.com/xieruiwei/xieruiwei.github.io.git
	  branch: master
...
　然后再浏览器中输入[http://xieruiwei.github.io/](http://xieruiwei.github.io/)就行了，我的 github 的账户叫 xieruiwei ,把这个改成你 github 的账户名就行了
...
转载请注明原地址，小k.o的博客：[http://xieruiwei.github.io](http://xieruiwei.github.io) 谢谢！
